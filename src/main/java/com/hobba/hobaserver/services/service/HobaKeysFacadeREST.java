...
public class HobaKeysFacadeREST extends AbstractFacade<HobaKeys> {
    ...
    public HobaKeysFacadeREST() {
        super(HobaKeys.class);
    }

    @POST
    @Override
    @Consumes({"application/xml", "application/json"})
    public HobaKeys create(HobaKeys entity) {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, HobaKeys entity) {
        super.edit(entity);
    }
    ...
    public HobaKeys find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<HobaKeys> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
